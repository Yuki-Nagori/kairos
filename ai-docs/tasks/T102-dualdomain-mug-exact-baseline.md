...
- 目标：记录 Dual Domain 对照路线并保留恢复空间；当前 Mug 基线改用三维体网格，使用一致的几何、材料和工艺参数完成可审计实验。
...
| 当前 Kairos 网格  | 三维体网格；目标尺寸 5.0 mm；15,868 节点 / 48,605 四面体                                                                                                                       |
| Moldflow 参考网格 | Dual Domain；`33418` nodes；`66830` triangles                                                                                                                                  |
