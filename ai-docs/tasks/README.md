...
| T101 | [T101-generic-pp-material-fit.md](T101-generic-pp-material-fit.md)                           | Generic PP 自定义材料拟合与 Mug baseline        | 进行中：先补齐通用曲线输入、Tait/Cross-WLF 拟合、残差报告和自定义材料选择入口                           |
...
| [T99](T99-runtime-and-result-hardening.md) | 进行中 | 生命周期服务、场共享/统计/导出、DTO 与状态治理；第一批已完成生命周期状态机 |
