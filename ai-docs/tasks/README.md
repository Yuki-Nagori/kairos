...
| T74 | [T74-gate-velocity-si-recalibration.md](T74-gate-velocity-si-recalibration.md)             | 浇口速度阈值按 SI 重标定（对齐 20 m/s）          |
...
| T89 | [T89-gaim-integration.md](T89-gaim-integration.md)                                           | 气体辅助注塑集成（等上游）      | 上游三相 |
| T90 | [T90-mucell-pvt-approximation.md](T90-mucell-pvt-approximation.md)                           | 微发泡近似（PVT 修正）          | T81      |
| T91 | [T91-fiber-orientation-chain.md](T91-fiber-orientation-chain.md)                             | 纤维取向链路（等上游取向场）    | 上游取向 |
| T92 | [T92-doe-orchestration.md](T92-doe-orchestration.md)                                         | DOE / 正交试验编排              | T29      |
| T93 | [T93-process-optimization.md](T93-process-optimization.md)                                   | 工艺参数自动寻优                | T92      |
