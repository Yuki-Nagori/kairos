...
| ID  | 文件                                                                                         | 任务                                            | 依赖 / 状态                                                                                                                                                                                               |
| --- | -------------------------------------------------------------------------------------------- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| T29 | [T29-real-solve-e2e.md](T29-real-solve-e2e.md)                                               | 真实求解端到端验证（OpenFOAM 环境）             | v0.2.5 轮三条链路已跑通；GUI 作业端到端已拆到 T94（含最小连通性复跑），剩视口截图与 XY 探针核验；4 进程并行：上游 **v1.0.0 已发版**（含 046 修复），Kairos 侧 np4 复测通过（退出码 0、1389 步到 endTime） |
