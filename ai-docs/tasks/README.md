...
| ID  | 文件                                                                                         | 任务                                           | 依赖 / 状态                                               |
| --- | -------------------------------------------------------------------------------------------- | ---------------------------------------------- | --------------------------------------------------------- |
| T21 | [T21-milestone-review.md](T21-milestone-review.md)                                           | 里程碑评审与整体优化（循环任务）               | **本轮收尾执行**（其他任务完成后跑一轮整体评审）          |
| T29 | [T29-real-solve-e2e.md](T29-real-solve-e2e.md)                                               | 真实求解端到端验证（OpenFOAM 环境）            | 求解链路真机复跑 + 前端视口验证（求解器仍在完善，放最后） |
| T33 | [T33-updater-hardening.md](T33-updater-hardening.md)                                         | 发布加固：自动更新与 CSP 收窄                  | 等签名证书；CSP 收窄可先行                                |
