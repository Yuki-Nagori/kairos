...
describe("LogTabs", () => {
  ...
  it("VM 终端页展示 Shell 输出", async () => {
    appStore.set({ vmShellLogs: ["$ ls", "case"] });
    const wrapper = mount(LogTabs);
