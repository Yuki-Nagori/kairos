...
import VmPanel from "./components/panels/VmPanel.vue";
import ViewportPanel from "./components/panels/ViewportPanel.vue";
import XyChartPanel from "./components/panels/XyChartPanel.vue";
import ResultsPanel from "./components/panels/ResultsPanel.vue";
import ProjectTree from "./components/panels/ProjectTree.vue";
import PipelinePanel from "./components/panels/PipelinePanel.vue";
import MaterialsPanel from "./components/panels/MaterialsPanel.vue";
import GeometryPanel from "./components/panels/GeometryPanel.vue";
import MoldPanel from "./components/panels/MoldPanel.vue";
